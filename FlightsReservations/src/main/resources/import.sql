...
INSERT INTO users (dtype, id, address, email, first_name, last_name, password, phone, enabled, last_password_reset_date) VALUES ("User", 1, 'adresa1', 'user@example.com', 'Marko', 'Markovic', '$2a$10$faqFjU6Eihfn6tKTKKqlV.a9hFzfKrOde0sIjuE9WVqlMs/P.WLAu', '01234', true, '2017-10-01 21:58:58');
INSERT INTO users (dtype, id, address, email, first_name, last_name, password, phone, enabled, last_password_reset_date) VALUES ("User", 2, 'adresa2', 'admin@example.com', 'Nikola', 'Nikolic', '$2a$04$Vbug2lwwJGrvUXTj6z7ff.97IzVBkrJ1XfApfGNl.Z695zqcnPYra', '97412' , true, '2017-10-01 18:57:58');
...
INSERT INTO company (dtype, id, name, latitude, longitude, promo_description, average_score, number_of_votes) VALUES ("Airline", 1, 'airline1', 26.921, 33.124, 'description1', 4.75, 22);
